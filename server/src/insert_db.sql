...
INSERT INTO `machine` (`id`, `title`, `os`, `osArchitecture`, `osInstallDate`, `osVersion`, `osOrganization`, `osSerialNumber`, `motherboardManufacturer`, `processor`, `userId`) VALUES
    ('3a0b08d4a-ba3f071a9a391250', 'Máquina Trabalho', 'Microsoft Windows 11 Pro', '64 bits', '2025-10-22 19:31:11', '10.0.26100', 'Trabalho ABC', '00380-51207-50199-SSQER', 'Dell Inc.', 'Intel(R) Core(TM) i5-8500T CPU @ 2.10GHz', '3b425bb05-c1a5d71484582211');

INSERT INTO machine_disk (id, freeSpace, size, machineId) VALUES
    ('3c9387df4-24bb51b06ac74f2d', 380380033024, 498648223744,'3a0b08d4a-ba3f071a9a391250');
