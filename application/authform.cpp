...
void inventory::AuthForm::setupUI()
{
    ...
    vSizer->Add(lbTitle = new wxStaticText(this, wxID_ANY, wxString::FromUTF8("Inventário de Máquinas"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL), 0, wxEXPAND);
    ...
    vSizer->Add(btnMachine = new wxButton(this, wxID_ANY, wxString::FromUTF8("dados da máquina (leitura)")), flags);
    vSizer->AddStretchSpacer();
...
void inventory::AuthForm::OnBtnCreateAccount(wxCommandEvent& event)
{
    ...
    case CREATE_ACCOUNT:
        ...
        if (newUserData.password != txtPassConfirm->GetValue()) {
            ShowMessage(wxString::FromUTF8("As senhas são diferentes!"));
            return;
        }
